import { Container, Card, Grid, Text, Title, Group, Box, Table, List, Stack } from '@mantine/core';
...
const dataClientesPorRegion = [
  { region: 'Córdoba', cantidad: 50 },
  { region: 'Buenos Aires', cantidad: 40 },
  { region: 'Santa Fe', cantidad: 30 },
  { region: 'Mendoza', cantidad: 25 },
  { region: 'Salta', cantidad: 20 },
  { region: 'Neuquén', cantidad: 18 },
  { region: 'Chubut', cantidad: 15 },
  { region: 'Misiones', cantidad: 12 },
];
    ...
    <Container fluid p="0">
      ...
      >
        <Group wrap='nowrap' className='header__title'>
          <Title order={2} className="header__title-name color-white">Dashboard</Title>
        </Group> 
      </Group>
      <Stack p="lg" align="stretch" justify="center">
        ...
        <Grid mb="md">
            ...
            <Card className='card' shadow="sm" style={{ height: '100%' }}>
              ...
              <ResponsiveContainer width="100%" height={250}>
                <BarChart data={dataVentasMensuales}>
                  ...
                  />
                  <Bar dataKey="ventas" fill="#A4AEC4" />
                </BarChart>
              </ResponsiveContainer>
            </Card>
          </Grid.Col>
          <Grid.Col span={{ base: 12, md: 12, lg: 6 }} style={{ height: 'auto' }}>
            <Card className='card' shadow="sm" style={{ height: '100%' }}>
              <Text className='title-dashboard'>CLIENTES POR PROVINCIA</Text>
              <ResponsiveContainer width="100%" height={300}>
                <BarChart data={dataClientesPorRegion} layout="vertical">
                  ...
                  <Tooltip 
                    ...
                    labelStyle={{ color: '#ffffff' }}
                  />
                  <Bar dataKey="cantidad" fill="#A4AEC4" barSize={20} />
                </BarChart>
              </ResponsiveContainer>
            </Card>
          </Grid.Col>
